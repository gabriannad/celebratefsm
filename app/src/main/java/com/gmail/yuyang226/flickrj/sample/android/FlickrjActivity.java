...
import gabrianna.cs160.berkeley.edu.celebratefsm.DrawingActivity;
import gabrianna.cs160.berkeley.edu.celebratefsm.MainActivity;
...
public class FlickrjActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getIntent().getExtras() != null) {
            ...
            if (getIntent().getExtras().containsKey("flickDrawing")) {
                bitmap = getIntent().getParcelableExtra("flickDrawing");
            }
